...
const JOBS = [
    ...
    "company": "Công Ty Cổ Phần Dược Phẩm Đạt Vi Phú ( DAVIPHARM )",
    "district": "P. Xuân Hoà",
    ...
    "requirements": [
        ...
        "1-2 năm kinh nghiệm content marketing, digital marketing trong lĩnh vực Dược phẩm.",
        "Biết sử dụng phần mềm thiết kế, chỉnh sửa video (capcut, canva...).",
        "Biết sử dụng các công cụ AI (Claude, Copilot, GPT).",
        "Có kinh nghiệm quản trị social media, wordpress. SEO website."
    ],
    "benefits": [
